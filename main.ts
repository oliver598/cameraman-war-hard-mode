...
controller.A.onEvent(ControllerButtonEvent.Released, function () {
    projectile = sprites.createProjectileFromSprite(img`
        2 
        `, mySprite, 50, 0)
    music.play(music.createSoundEffect(WaveShape.Square, 3054, 5000, 255, 255, 300, SoundExpressionEffect.None, InterpolationCurve.Curve), music.PlaybackMode.UntilDone)
})
...
let my_scibidi: Sprite = null
let mySprite: Sprite = null
game.splash("scibid toilet must be touched to win")
mySprite = sprites.create(img`
    ...
    . . . . f f f f f f f f . . . . 
    `, SpriteKind.Player)
mySprite.setPosition(139, 103)
my_scibidi = sprites.create(assets.image`scibidi`, SpriteKind.Enemy)
scene.setBackgroundImage(img`
    ...
    `)
scene.cameraFollowSprite(my_scibidi)
